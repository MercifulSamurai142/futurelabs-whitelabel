...
const HeroBanner = () => {
  ...
  const translations = {
    english: {
      Name: "Futurelab Studios ",
      mainTitle: "Main Title",
      mainTitleSecond: "Title Continuation",
      description: "Description of the Hero Banner goes here. This is a brief introduction to the content or purpose of the website.",
      startLearning: "Start Learning",
      viewProgress: "View Progress",
      modules: "No. of Modules",
      comprehensiveCoverage: "Relative tag",
      certifications: "Certifications",
      industryRecognized: "Industry Recognized"
    },
    hindi: {
      Name: "फ्यूचरलैब स्टूडियोज",
    ...
    kannada: {
      Name: "ಫ್ಯೂಚರ್‌ಲ್ಯಾಬ್ ಸ್ಟುಡಿಯೋಸ್",
  ...
  return (
    <div className="relative w-full overflow-hidden mb-8">
      <div className="bg-gradient-to-r from-blue-400 via-cyan-500 to-green-500 p-8 md:p-10">
        <div className="flex flex-col md:flex-row items-center">
          <div className="flex-1">
            <div className="flex items-center mb-3">
              <BookOpen className="text-white mr-2" size={24} />
              <h2 className="text-white text-lg font-medium">{t.Name}</h2>
            </div>
