        ...
        <div className="flex items-center gap-3">
          ...
          <div className="rounded-full bg-orange-500 h-8 w-8 flex items-center justify-center text-white font-medium">
            {profile?.profile_picture ? (
              ...
              <div className="w-full h-full rounded-full bg-primary flex items-center justify-center text-white text-1xl font-medium">
                FLS
              </div>
            )}
          </div>
          <div className="hidden md:block">
            ...
            <p className="text-xs text-muted-foreground">Futurelab Studios</p>
          </div>
        </div>
      </div>
    </header>
