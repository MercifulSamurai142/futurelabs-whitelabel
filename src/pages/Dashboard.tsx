...
const Dashboard = () => {
  ...
  const translations = {
    english: {
      welcomeTitle: "Welcome to Futurelab Studios",
      welcomeSubtitle: "Track your progress and continue your learning journey",
      courseProgress: "Course Progress",
      modulesCompleted: "Modules Completed",
      yourModules: "Your Modules : Modules created in the selected language will be shown here",
    ...
    hindi: {
      welcomeTitle: "फ्यूचरलैब स्टूडियोज एकेडमी में आपका स्वागत है",
    ...
    kannada: {
      welcomeTitle: "ಫ್ಯೂಚರ್‌ಲ್ಯಾಬ್ ಸ್ಟುಡಿಯೋಸ್",
